...
inv <- read.csv("macroinvertebrate summary 3.20.16.csv")
str(inv)
...
inv.plot + facet_wrap(~variable) +
  geom_boxplot() + ggtitle("Macroinvertebrates") + ylab("Individuals/sample") + xlab("") + 
...
#save data
ggsave("macroinvertebrate_summary_3_20_16.pdf")
ggsave("macroinvertebrate_summary_3_20_16.png", dpi = 400)
